    ...
    <div className="flex flex-col items-center min-h-screen bg-gray-50 p-6 pt-24">
      <div className="w-full max-w-2xl bg-white rounded-lg shadow-lg p-8">
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
          ...
          <button
            type="submit"
            className="w-full py-4 bg-cyan-600 text-white rounded-lg font-semibold hover:bg-cyan-700 transition-all duration-200 transform hover:-translate-y-1 hover:shadow-md mt-8"
          >
            Create Venue
          </button>
        </form>
